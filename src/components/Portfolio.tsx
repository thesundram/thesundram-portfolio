  ...
  const projects = [
    {
      ...
      image: '/images/projects/invoice-xtract.png',
      description: 'End-to-end AI system to extract structured data from invoice images with high accuracy.',
      longDescription: 'Developed an end-to-end invoice processing system to extract structured data (vendor, customer, line items, GST, truck/PO numbers) from invoice images. Implemented OCR using Google Cloud Vision API and integrated AI-based data extraction using OpenAI GPT-4o for improved accuracy. Designed a dual-processing pipeline combining image-based and text-based extraction (GPT-4o Vision + GPT-3.5 Turbo) with fallback logic for enhanced reliability. Optimized data parsing and validation to ensure consistent and structured output for downstream processing.',
      tech: ['Node.js', 'Express', 'Next.js', 'Google Vision OCR', 'OpenAI GPT-4o'],
      ...
      team: 'Solo',
      rating: 4.9,
      features: ['OCR Data Extraction', 'GPT-4o Integration', 'GST & Item Parsing', 'Fallback Logic']
    },
    {
      id: 9,
      title: 'DermaScan AI – Face & Skin Analysis',
      category: 'Mobile Development',
      image: '/images/projects/dermascan-ai.png',
      description: 'ML-powered facial scanning system identifying health metrics and skin concerns.',
      longDescription: 'A cutting-edge medical AI application built with React Native for a seamless mobile experience. The app utilizes a Python-based ML/DL backend to perform a full facial mesh scan. It identifies skin issues, health metrics, and provides personalized health advice. Built using TensorFlow, PyTorch, and MediaPipe for precise facial feature detection and real-time image processing.',
      tech: ['React Native', 'Python', 'FastAPI', 'TensorFlow', 'MediaPipe', 'PyTorch', 'OpenCV'],
      github: 'https://github.com/thesundram',
      live: 'https://thesundram.vercel.app',
      status: 'In Progress',
      year: '2025',
      ...
      team: 'Solo',
      rating: 4.8,
      features: ['Facial Mesh Detection', 'ML Health Metrics', 'Skin Issue Identification', 'Real-time Mobile Analysis']
    },
    {
      id: 10,
      title: 'SyncSpace – Real-time Collaboration SaaS',
      category: 'Web Development',
      image: '/images/projects/syncspace.png',
      description: 'Multiplayer collaborative platform with real-time editing and presence tracking.',
      longDescription: 'A high-demand collaborative platform built for modern teams. Features real-time multiplayer editing (CRDTs), live cursor tracking, presence indicators, and persistent state management. Optimized for low-latency interactions and high scalability.',
      ...
      team: 'Solo',
      rating: 5.0,
      features: ['Multiplayer Editing', 'Real-time Cursors', 'Presence Tracking', 'Cloud Sync']
    },
    {
      id: 1,
