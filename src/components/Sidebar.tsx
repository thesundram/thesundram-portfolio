        ...
        <>
                    ...
                    <div className="space-y-3">
                        <div className="flex items-center justify-center space-x-3">
                            {[
                                ...
                                { icon: Instagram, href: 'https://www.instagram.com/its.sun29/', label: 'Instagram', color: 'hover:bg-pink-500/20 hover:border-pink-500/30' },
            ...
            <motion.header
                ...
                className={`fixed top-0 left-0 right-0 z-50 lg:hidden transition-all duration-500 ${scrolled
                    ? 'bg-white/90 dark:bg-[#0a0a0a]/95 backdrop-blur-xl border-b border-gray-200 dark:border-primary/20 shadow-lg'
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="fixed inset-0 z-40 bg-white/95 dark:bg-[#0a0a0a]/95 backdrop-blur-2xl lg:hidden pt-24"
                    >
