        ...
        {items.map((item, index) => (
          ...
          >
            ...
            <motion.div
              ...
              whileTap={{ scale: 0.99 }}
              className="bg-white/5 backdrop-blur-sm rounded-lg sm:rounded-xl p-4 sm:p-6 border border-white/10 hover:border-primary/30 transition-all duration-300 group"
            >
